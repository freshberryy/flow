...
public class VoidValue extends Value {
    ...
    public int asInt(int line, int col) {
        throw new RuntimeError("타입 캐스팅 오류: void 타입을 int로 캐스팅할 수 없습니다.", line, col);
    }
    @Override
    public float asFloat(int line, int col) {
        throw new RuntimeError("타입 캐스팅 오류: void 타입을 float로 캐스팅할 수 없습니다.", line, col);
    }
    @Override
    ...
    public boolean asBoolean(int line, int col) {
        throw new RuntimeError("타입 캐스팅 오류: void 타입을 bool로 캐스팅할 수 없습니다.", line, col);
    }
    @Override
    public String asString(int line, int col) {
        throw new RuntimeError("타입 캐스팅 오류: void 타입을 string으로 캐스팅할 수 없습니다.", line, col);
    }

    @Override
    public Value performBinaryOperation(Value other, String operator, int line, int col) {
        throw new RuntimeError("void 타입은 연산을 할 수 없습니다.", line, col);
    }

    @Override
    public Value performUnaryOperation(String operator, int line, int col) {
        throw new RuntimeError("void 타입은 단항 연산을 할 수 없습니다.", line, col);
    }
