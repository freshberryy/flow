...
public class FunctionValue extends Value {
    ...
    public String getType() {
        ...
        return functionObject.getReturnType().getBaseType() + " function";
    }

    @Override
    public FunctionObject getValue() {
    ...
    @Override
    public boolean isTruth() { return true; } 
    ...
    public Value performBinaryOperation(Value other, String operator, int line, int col) {
        throw new RuntimeError("함수 타입은 연산을 할 수 없습니다.", line, col);
    }

    @Override
    public Value performUnaryOperation(String operator, int line, int col) {
        throw new RuntimeError("함수 타입은 단항 연산을 할 수 없습니다.", line, col);
    }

    @Override
    public int asInt(int line, int col) {
        throw new RuntimeError("타입 캐스팅 오류: 함수 타입을 int로 캐스팅할 수 없습니다.", line, col);
    }
    @Override
    public float asFloat(int line, int col) {
        throw new RuntimeError("타입 캐스팅 오류: 함수 타입을 float로 캐스팅할 수 없습니다.", line, col);
    }
    @Override
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(functionObject, that.functionObject);
    }

    @Override
    public int hashCode() {
        return Objects.hash(functionObject);
    }
    @Override
